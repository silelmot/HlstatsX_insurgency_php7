...
<?php 
		...
		while ($thisteam = $db->fetch_array($statsdata))
		{
			...
			$pldata = $db->query("
								SELECT
									hlstats_Livestats.player_id, 
									hlstats_Livestats.name, 
									hlstats_Livestats.kills, 
									hlstats_Livestats.deaths, 
									hlstats_Livestats.headshots, 
									hlstats_Livestats.ping, 
									hlstats_Livestats.skill, 
									hlstats_Livestats.shots, 
									hlstats_Livestats.hits, 
									hlstats_Livestats.connected, 
									hlstats_Livestats.skill_change, 
									hlstats_Livestats.cli_flag,
									hlstats_Livestats.steam_id
								FROM 
									hlstats_Livestats
								INNER JOIN hlstats_Players 
								ON hlstats_Livestats.player_id = hlstats_Players.playerId
								WHERE 
									server_id = $server_id 
									AND team = '$teamname'
