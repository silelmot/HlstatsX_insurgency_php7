...
public Action:Event_PlayerDeath(Handle:event, const String:name[], bool:dontBroadcast)
{
	...
	if (StrEqual(weapon,"grenade_molotov") || StrEqual(weapon,"grenade_anm14"))
	{
		LogPlyrPlyrEvent(attacker, victim, "triggered", "burned");
	}
	...
	if (attacker == victim )
	{
		LogPlayerEvent(victim, "triggered", "selfkill");	
	}
	...
	LogPlyrPlyrEvent(attacker,victim, "triggered", "death");
